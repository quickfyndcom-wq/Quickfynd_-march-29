            ...
            return (
                <div className="rounded-xl border border-blue-100 bg-blue-50/40 px-4 py-3">
                    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                        <p className="text-sm font-medium text-slate-700">Sign in to rate this product and write a review.</p>
                        <button
                            type="button"
                            onClick={() => router.push('/sign-in')}
                            className="inline-flex items-center justify-center rounded-md bg-[#E6003E] px-4 py-2 text-sm font-semibold text-white hover:bg-[#C70036] transition"
                        >
                            Sign in
                        </button>
                    </div>
