...
export default function ProductFilterSidebar({ 
  ...
  return (
    <div className="w-full lg:w-64 lg:self-start bg-white border border-gray-200 rounded-lg p-4 h-fit lg:sticky lg:top-24 lg:overflow-y-auto lg:max-h-[calc(100vh-6rem)]">
      {/* Sort By */}
      <div className="mb-6">
