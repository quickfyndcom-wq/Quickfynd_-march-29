...
const Footer = () => {
    const appStoreToastId = 'app-store-coming-soon';

    const handlePlayStoreClick = () => {
        window.open('https://play.google.com/store/apps/details?id=com.quickfynd', '_blank', 'noopener,noreferrer');
    };

    const handleAppStoreClick = () => {
        toast('App is coming soon on the App Store', {
            id: appStoreToastId,
            duration: 2500,
        });
    };
        ...
        <div className={wrapperClassName}>
            ...
            <div className="flex flex-wrap items-center gap-1.5">
                <button
                    ...
                    className="shrink-0 rounded-md focus:outline-none focus:ring-2 focus:ring-slate-600 focus:ring-offset-2 focus:ring-offset-black"
                    aria-label="Open Quickfynd on Play Store"
                >
                    <Image
                        src={PlayStoreBadge}
            ...
            <div className="max-w-[1700px] mx-auto px-2 sm:px-3 lg:px-4">
                ...
                <div className="py-2 grid grid-cols-2 gap-2 md:grid-cols-2 lg:grid-cols-6 md:gap-4 lg:gap-6">
                    ...
                    <div className="col-span-2 lg:col-span-2">
                        ...
                        {appDownloadSection("mt-3 hidden max-w-xs lg:block")}
                ...
                {appDownloadSection("border-t border-slate-800 pt-5 pb-1 lg:hidden")}
