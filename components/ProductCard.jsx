...
const ProductCard = ({ product, compact = false }) => {
    ...
    const displayName = (product.name || product.title || 'Untitled Product').trim()
    ...
    return (
        ...
        >
            <div className={`bg-white ${compact ? 'rounded-xl' : 'rounded-2xl'} shadow-sm hover:shadow-lg transition-shadow duration-300 overflow-hidden flex flex-col h-full relative`}>
                {/* Product Image */}
                ...
                <div className="flex flex-col p-2 sm:p-2.5">
                    <h3 className="h-[2.25rem] sm:h-[2.7rem] text-xs sm:text-sm font-semibold text-gray-900 leading-[1.125rem] sm:leading-[1.35rem] line-clamp-2 overflow-hidden break-words mb-1">
                        {displayName}
                    </h3>
