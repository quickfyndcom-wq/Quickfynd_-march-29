                        ...
                        <div className={embedded ? '' : 'lg:flex-1 lg:min-w-0 lg:pr-3 xl:pr-4 lg:pt-3 xl:pt-4'}>
                            <div className="mb-4 rounded-xl border border-slate-200 bg-white px-4 py-3">
                                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                                    <h3 className="text-[22px] font-bold leading-none text-gray-900 sm:text-4xl">{sortedAndFilteredReviews.length} {sortedAndFilteredReviews.length === 1 ? 'Review' : 'Reviews'}</h3>
