...
### Extracted Products Return Policy

**Important:** Extracted/Opened products have a **restricted return policy**:

- **Full Refund Returns:** NOT available for extracted/opened products
- **Replacement Only:** Extracted products can only be exchanged for a replacement
- **Applicable to:** Products that have been extracted from original packaging or sealed boxes, beauty/cosmetic items with broken seals, food/edible items opened/exposed, bundled items broken apart, demo/trial products, and similar opened/extracted items
- **Reason:** Extracted or opened products cannot be resold as "new" due to hygiene concerns, contamination risk, product integrity compromise, and safety standards
- **Exception:** If item arrives already extracted/opened without customer action, replacement is guaranteed within 15 days
- **No restocking fee:** Replacement shipment is free; seller covers all costs
...
- **NOT available for extracted/opened products** (see Extracted Products Policy above)
- Available for: Clothing (unused), footwear (unworn), accessories, sealed home & kitchen items, sealed beauty products, books, toys, and other sealed/unopened items
...
### Q17: Can I return extracted or opened products for a refund?

**A:** No, extracted or opened products **cannot be returned for a refund**. Here's what you need to know:

- **Only replacement available:** If you receive a product that has been extracted or opened (e.g., beauty items with broken seals, bundled items separated, demo products, food items exposed), you can **only request a replacement**, not a refund
- **Why this policy?** Extracted or opened products cannot be resold as "new" due to hygiene concerns, product integrity compromise, contamination risks, and safety standards
- **Warranty protection:** Replacement is still free and guaranteed within 15 days of delivery
- **What qualifies for replacement?**
  - Item arrives already extracted/opened without your action
  - Beauty/cosmetic items with broken or tampered seals
  - Bundled items that have been separated
  - Demo or trial products
  - Food items that are exposed or opened
  - Manufacturing defects detected in extracted item
  - Damage on arrival of extracted item
- **Timeline:** Replacement request approved within 24 hours; seller arranges free pickup and ships new item within 2-3 business days
- **Important:** If the item arrives already extracted/opened due to courier or seller error (not customer action), this qualifies for immediate replacement
- **Example:** You order a beauty serum and it arrives with the seal broken. You cannot get a refund, but the seller will replace it with a sealed, new product at no cost within 5-7 days total
