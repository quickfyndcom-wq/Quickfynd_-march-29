  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-[1700px] mx-auto px-2 sm:px-3 lg:px-4 py-8">
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Under ₹499</h1>
          <p className="text-gray-600">Great finds priced at ₹499 or less</p>
        </div>
          ...
          <div className="flex-1">
            {filteredAndSortedProducts.length === 0 ? (
              <div className="text-center py-16 bg-white rounded-lg border border-gray-200">
                <p className="text-gray-500 text-lg">No products under ₹499 match your filters.</p>
                <button
