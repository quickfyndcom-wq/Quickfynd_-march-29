...
try {
  if (fs.existsSync(serviceAccountPath)) {
    ...
    console.warn('⚠️ Firebase Admin credentials missing: add firebase-key.json or FIREBASE_SERVICE_ACCOUNT_KEY');
  }
  ...
  console.error('❌ Firebase Admin credential parsing error:', e.message);
}
